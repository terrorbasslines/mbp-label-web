...
<html lang="en">
  ...
  <body>
    <header class="top"><div class="wrap"><a class="brand" href="/"><img src="/assets/brand/logo-clear.png" alt="" />${SITE_NAME}</a><nav class="nav"><a href="/releases">Releases</a><a href="/artists">Artists</a><a href="/demo-submission">Submit demo</a><a href="/contact">Contact</a><a href="/artist-dashboard">Login</a></nav></div></header>
