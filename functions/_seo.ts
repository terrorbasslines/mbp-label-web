  ...
  <head>
    ...
    <style>
      ...
      *{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at 12% 0%,rgba(143,53,255,.2),transparent 34%),var(--bg);color:var(--text);font-family:Inter,Arial,sans-serif}
      a{color:inherit}.wrap{width:min(1280px,calc(100% - 40px));margin:0 auto}.top{border-bottom:1px solid var(--line);background:rgba(5,5,8,.82);position:sticky;top:0;backdrop-filter:blur(16px);z-index:10}.top .wrap{display:flex;align-items:center;justify-content:space-between;gap:20px;padding:12px 0}.brand{display:flex;align-items:center;gap:12px;text-decoration:none}.brand img{width:44px;height:44px;border:1px solid var(--line);border-radius:6px;background:#000;object-fit:contain}.brand strong{display:block;font-size:18px;line-height:1;font-weight:1000;text-transform:uppercase;letter-spacing:0}.brand .sub{display:block;margin-top:5px;font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.28em;color:#8f94a8}.nav{display:flex;flex-wrap:wrap;align-items:center;gap:6px}.nav a{border-radius:6px;padding:10px 12px;font-size:12px;font-weight:900;text-transform:uppercase;letter-spacing:.12em;text-decoration:none;color:#d6d8e2}.nav a:hover{background:rgba(255,255,255,.1);color:#fff}
